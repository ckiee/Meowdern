...
local osc_styles = {
    ...
    SeekbarBg = '{\\blur0\\bord0\\1c&H87A3C1&}',
    SeekbarFg = '{\\blur1\\bord1\\1c&HE9D2AF&}',  --color!
    VolumebarBg = '{\\blur0\\bord0\\1c&H999999&}',
    VolumebarFg = '{\\blur1\\bord1\\1c&HE9D2AF&}',
...
layouts = function ()
    ...
    lo.geometry = {x = refX , y = refY - 52 , an = 5, w = osc_geo.w - 50, h = 2}
    lo.layer = 13
    ...
    lo.geometry = {x = refX, y = refY - 52 , an = 5, w = osc_geo.w - 50, h = 16}
    ...
    lo.geometry = {x = 25, y = refY - 40, an = 7, w = 64, h = 20}
    lo.style = osc_styles.Time	
	

    lo = add_layout('tc_right')
    lo.geometry = {x = osc_geo.w - 25 , y = refY -40, an = 9, w = 64, h = 20}
    lo.style = osc_styles.Time	

    geo = { x = 25, y = refY - 88, an = 1, w = osc_geo.w - 50, h = 48 }
    lo = add_layout('title')
    lo.geometry = geo
